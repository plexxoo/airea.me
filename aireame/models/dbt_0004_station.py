...
db.define_table('station',
    Field('identifier', 'double', label=T('Identifier')),
    Field('zone', 'reference zone', label=T('Zone')),
    Field('province', 'reference province', label=T('Province')),
    Field('town', 'reference town', label=T('Town')),
    Field('name', 'string', length=50, label=T('Name')),
    Field('code', 'string', length=6, label=T('Code')),
    Field('address', 'string', length=200, label=T('Address')),
    Field('latitude', 'double', label=T('Latitude')),
    Field('longitude', 'double', label=T('Longitude')),
