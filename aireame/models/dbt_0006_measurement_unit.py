...
db.define_table('measurement_unit',
    Field('code', 'string', length=20, label=T('Code')),
    Field('literal', 'string', length=50, label=T('Literal')),
    Field('units', 'string', length=10, label=T('Units')),
    format='%(literal)s (%(units)s)')
