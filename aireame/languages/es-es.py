...
'Last Seven Days': 'Últimos Siete Días',
'Last Year': 'Último Año',
'Last month data': 'Último mes',
'Last name': 'Apellido',
'Last saved on:': 'Guardado en:',
'Last seven days data': 'Última semana',
'Latitude': 'Latitud',
...
'Remember me (for 30 days)': 'Recordar (por 30 días)',
'Reset Password key': 'Restaurar clave',
...
'User %(id)s Logged-in': 'Usuario %(id)s ha accedido',
